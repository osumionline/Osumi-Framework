...
$locale = [
	...
	'TASK_UPDATE_URLS' => 'Updates URLs cache file',
	'TASK_UPDATE_URLS_UPDATING' => 'Updating modules/actions...',
	...
	'TASK_UPDATE_URLS_NEW_MODULE' => 'New module "%s" created on file "%s".',
	'TASK_UPDATE_URLS_NEW_TEMPLATE_FOLDER' => 'New template folder "%s" created.',
	'TASK_UPDATE_URLS_NEW_ACTION' => 'New action "%s" created on module "%s".',
	'TASK_UPDATE_URLS_NEW_TEMPLATE' => 'New template "%s" created.',
	'TASK_UPDATE_URLS_ERROR' => 'There were errors updating modules and actions. Check the errors and run again the "updateUrls" task',
	'TASK_UPDATE_URLS_ALL_UPDATED' => 'Everything is up to date.',
	'TASK_VERSION' => 'Get Frameworks current version information.',
	'TASK_ADD' => 'Add new modules, actions, services or tasks.',
	'TASK_ADD_DEFAULT_NOT_VALID' => 'Indicated command is not a valid option.',
	'TASK_ADD_DEFAULT_AVAILABLE_OPTIONS' => 'Available options are:',
	'TASK_ADD_DEFAULT_MODULE' => 'Create a new module',
	'TASK_ADD_DEFAULT_ACTION' => 'Create a new action in a module',
	'TASK_ADD_DEFAULT_SERVICE' => 'Create a new service',
	'TASK_ADD_DEFAULT_TASK' => 'Create a new task',
	'TASK_ADD_DEFAULT_MODEL_COMPONENT' => 'Create a component for a model',
	'TASK_ADD_MODULE_ERROR' => 'You must indicate the name of the module you want to create, for example:',
	'TASK_ADD_MODULE_EXISTS' => 'Module file "%s" already exists.',
	'TASK_ADD_MODULE_NEW_MODULE' => 'New module "%s" created:',
	'TASK_ADD_MODULE_NEW_FOLDER' => 'New folder "%s" created.',
	'TASK_ADD_MODULE_NEW_FILE' => 'New file "%s" created.',
	'TASK_ADD_ACTION_MESSAGE' => 'New action %s',
	'TASK_ADD_ACTION_TEMPLATE' => 'New action <strong>%s</strong> works!',
	'TASK_ADD_ACTION_ERROR' => 'You must indicate the name of the module where the action should go, the name of the action you want to create and it\'s URL. For example:',
	'TASK_ADD_ACTION_OPTIONAL' => 'OPTIONAL: You can indicate the type of the return the new action will do (default type is html), for example:',
	'TASK_ADD_ACTION_NO_MODULE' => 'Required module "%s" could not be found on "%s"',
	'TASK_ADD_ACTION_EXISTS' => 'Action "%s" already exists.',
	'TASK_ADD_ACTION_TEMPLATE_EXISTS' => 'Template file "%s" already exists.',
	'TASK_ADD_ACTION_NEW_ACTION' => 'New action "%s" created on module "%s".',
	'TASK_ADD_ACTION_NEW_TEMPLATE' => 'New template file "%s" created.',
	'TASK_ADD_ACTION_URLS_UPDATED' => 'URLs cache file has been updated.',
	'TASK_ADD_SERVICE_ERROR' => 'You must indicate the name of the service you want to create, for example:',
	'TASK_ADD_SERVICE_EXISTS' => 'Service file "%s" already exists.',
	'TASK_ADD_SERVICE_NEW_SERVICE' => 'New service "%s" created:',
	'TASK_ADD_SERVICE_NEW_FILE' => 'New file "%s" created.',
	'TASK_ADD_TASK_MESSAGE' => 'New task %s',
	'TASK_ADD_TASK_ERROR' => 'You must indicate the name of the task you want to create, for example:',
	'TASK_ADD_TASK_EXISTS' => 'Task file "%s" already exists.',
	'TASK_ADD_TASK_NEW_TASK' => 'New task "%s" created:',
	'TASK_ADD_TASK_NEW_FILE' => 'New file "%s" created.',
	'TASK_ADD_MODEL_COMPONENT_ERROR' => 'You must indicate the name of the model whose component you want to create, for example:',
	'TASK_ADD_MODEL_COMPONENT_NO_MODEL' => 'Required model "%s" could not be found.',
	'TASK_ADD_MODEL_COMPONENT_FOLDER_EXISTS' => 'Folder "%s" already exists.',
	'TASK_ADD_MODEL_COMPONENT_FILE_EXISTS' => 'File "%s" already exists.',
	'TASK_ADD_MODEL_COMPONENT_FOLDER_CANT_CREATE' => 'Can\'t create folder "%s".',
	'TASK_ADD_MODEL_COMPONENT_FILE_CANT_CREATE' => 'Can\'t create file "%s".',
	'TASK_ADD_MODEL_COMPONENT_FOLDER_CREATED' => 'New folder "%s" created.',
	'TASK_ADD_MODEL_COMPONENT_FILE_CREATED' => 'New file "%s" created.',
	'TASK_ADD_MODEL_COMPONENT_USE' => 'New model component "%s" created. Use it with:',
